...
function commandEcho(cmd) {
  print(`<span class="prompt">C:\\Users\\SpooderVenom&gt;</span> ${esc(cmd)}`);
}

function boot() {
  print(`<div class="ascii">  _____                       _            __     __                            <br> / ____|                     | |           \\ \\   / /                            <br>| (___  _ __   ___   ___   __| | ___ _ __  \\ \\_/ /__ _ __   ___  _ __ ___    <br> \\___ \\| '_ \\ / _ \\ / _ \\ / _\` |/ _ \\ '__|  \\   / _ \\ '_ \\ / _ \\ '__/ __|   <br> ____) | |_) | (_) | (_) | (_| |  __/ |      | |  __/ | | |  __/ |  \\__ \\   <br>|_____/| .__/ \\___/ \\___/ \\__,_|\\___|_|      |_|\\___|_| |_|\\___|_|  |___/   <br>       | |                                                                  <br>       |_|                                                                  </div>`);
  print(`<span class="green">[OK]</span> portfolio.exe initialized`);
  print(`<span class="dim">Welcome to SpooderVenom's project directory.</span>`);
...
function showProjects() {
  ...
  for (const p of projects) {
    ...
    card.innerHTML = `
      ...
      <div class="project-links"><a href="${esc(p.repo)}" target="_blank" rel="noreferrer">[ repository ]</a></div>`;
...
function showAbout() {
  ...
  print(`Developer: <span class="blue">SpooderVenom</span>`);
  ...
  print(`Hosting target: <span class="green">your-name.is-a.dev</span>`);
  print();
}

function showContact() {
  print(`<span class="bold">CONTACT</span>`);
  print(`GitHub: <a class="blue" href="https://github.com/" target="_blank" rel="noreferrer">github.com</a>`);
...
function openProject(name) {
  ...
  const p = projects.find(x => x.name.toLowerCase() === q || x.name.toLowerCase().includes(q));
  if (!p) {
...
function runCommand(raw) {
  ...
  switch (verb.toLowerCase()) {
    ...
    case "projects": case "dir": case "ls": showProjects(); break;
    case "open": case "start":
      if (arg) openProject(arg); else print(`<span class="yellow">Usage:</span> open NAME`);
      break;
    case "about": showAbout(); break;
    case "contact": print(`<span class="dim">Contact info:</span>`); showContact(); break;
    case "status": showStatus(); break;
    case "clear": output.innerHTML = ""; break;
    case "cls": output.innerHTML = ""; break;
    case "whoami": print(`<span class="blue">SpooderVenom</span>`); print(); break;
    default:
